...
SUPPLIERS = [
    # Mercury EV standard usage - updated 05/2026
    {
        ...
        "public_dc_rate": 0.85,
        "gas": True,
        "bottle_charge_per_year": 372.117,
        "bottle_rental_per_year": 214,
    ...
    # Octopus Power - Peaker - updated 05/2026
    {
        ...
        "public_dc_rate": 0.85,
        "gas": False,
        "bottle_charge_per_year": 416.10,
        "bottle_rental_per_year": 323,
...
def simulate_battery_dispatch(
    ...
    for i, value in enumerate(net):
        ...
        if (
            ...
            target_day = target_date_for_interval(
                model.interval.index[i], peak_hours[0]
            )
